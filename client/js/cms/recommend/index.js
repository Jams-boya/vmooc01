...
(() => {
  ...
  /** 显示封面 */
  let showCover = function(val) {
    return `<img style='width:150px;height:100px' src = '${val}' >`;
  }

  /** 显示专家照片 */
  let showAvator = function(val) {
    if (!val)
      val = '/img/prot.png';
    return `<img alt='图片缺失，联系专家补全' style='width:100px;height:100px' src = '${val}' >`;
  }
    ...
    if (code === "manage") {
      ...
      if (module === "pic") {
        ...
        $.get("/cms/focuspic", {platform: "lcpsp"}, (result) => {
          ReactDom.render(
            <MyUploadPic value = {(result && result.pics) || []}>
            </MyUploadPic>,
            _domOp
          );
        });
      ...
      if (module === "coursecollection") {
        ...
        let _mymodal = ReactDom.render(
          <MyModal 
            ...
            tableColumn = {[{field: "cover", title: "专题封面", displayChange: showCover}, {field: "name", title: "专题名称"}]}
          >
            <MyDetailSearchBar
              coordinate = {"search"}
              hideDetail = {true}
      ...
      if (module === "expert") {
        ...
        let _mymodal = ReactDom.render(
          <MyModal 
            ...
            tableColumn = {[{field: "lifePhoto", title: "讲师照片", displayChange: showAvator}, {field: "name", title: "姓名"}, {field: "professionalTitle", title: "职称"}]}
          >
            <MyDetailSearchBar
              coordinate = {"search"}
              hideDetail = {true}
