...
let page_url = "/getMyPeekCount";
let data_url = "/getMyPeek";
...
function onTrClick(mrow) {
  let answerId = mrow.answerId;
  $.post('/mypeek/findQuestionId', { answerId }, (data) => {
    if (data) {
      window.location.href = '/expertqa/' + data.questionId + '/' + mrow.userId;
    }
  })
}