...
var options = [{ "libraryName": "antd", "style": 'css' }];
...
function copyPlugins() {
  fs.removeSync('dist/');
  fs.mkdirsSync('dist/');
  fs.copySync('client/img', 'dist/img');
  fs.copySync('client/images', 'dist/images');
  fs.copySync('client/uploadImg', 'dist/uploadImg');
  fs.copySync('client/css', 'dist/css');
  fs.copySync('client/common', 'dist/common');
  fs.copySync('client/updateDetail.html', 'dist/updateDetail.html');
